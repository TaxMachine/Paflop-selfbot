...
module.exports= {
    ...
    console.clear()
    console.log(greenBright("Loading Paflop Skidbot..."))
            ...
            if (config.rpc === true) {
                ...
                drg.getRpcImage("862317771312726027", "icon").then(image => {
                    let presence = new drg.Rpc()
                        .setName("Paflop Skidbot")
                        .setUrl("https://www.twitch.tv/paflopskidbot")
                        .setType("STREAMING")
                        .setApplicationId("862317771312726027")
                        .setAssetsLargeImage(image.id)
                        .setAssetsLargeText(" v" + floppaversion)
                        .setDetails("Paflop Skidbot")
    ...
    bot.on("message", async message => {
        ...
        if (message.content.startsWith(`${prefix}ping`)) {
            ...
            let pingEmbed = new Discord.RichEmbed()
                .setAuthor("Paflop Skidbot.", 'https://i.imgur.com/Hcylg0h.png')
                .setColor("RANDOM")
        ...
        if (message.content.startsWith(`${prefix}8b`)) {
            ...
            let errEmbed = new Discord.RichEmbed()
                .setAuthor("Paflop Skidbot AHAH get Skid nigga", 'https://i.imgur.com/Hcylg0h.png')
                .setColor("RED")
    ...
    token, prefix, autodel, massblacklist, masslist, rpc, messagelogger, messageloggerGuild
        ...
        if (message.content.startsWith(`${prefix}help`)) {
            ...
            let helpEmbed = new Discord.RichEmbed()
                ...
                .setTitle('')
                .setURL('')
                .setAuthor(`Paflop Skidbot v${floppaversion}.`, 'https://i.imgur.com/Hcylg0h.png')
        ...
        if (message.content.startsWith(`${prefix}about`)) {
            ...
            let about = new Discord.RichEmbed()
                .setAuthor("Paflop Skidbot.", 'https://i.imgur.com/Hcylg0h.png')
                .setDescription(`Paflop Skidbot is a free selfbot in javascript developped by rexo`)
...
:red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square::red_square:`)
        ...
        if (message.content.startsWith(`${prefix}nuke`)) {
            ...
            let missingPermEmbed = new Discord.RichEmbed()
                .setAuthor("Floppa", 'https://i.imgur.com/Hcylg0h.png')
                .setColor('#2ECC71')
        ...
        if (message.content.startsWith(`${prefix}webhook`)) {
            ...
            messages = args.slice(1).join(" ")
            if (!messages) messages = "This message was sent thanks to Paflop Skidbot :)"
